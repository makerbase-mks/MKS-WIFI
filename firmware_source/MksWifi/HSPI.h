...
public:
  ...
  void writeDwords(uint32_t * data, uint32_t size);
  void writePattern(uint8_t * data, uint8_t size, uint32_t repeat);
  void transferBytes(uint8_t * out, uint8_t * in, uint32_t size);
  void transferDwords(uint32_t * out, uint32_t * in, uint32_t size);
  void endTransaction(void);
private:
  bool useHwCs;
  void writeBytes_(uint8_t * data, uint8_t size);
  void writeDwords_(uint32_t * data, uint8_t size);
  void writePattern_(uint8_t * data, uint8_t size, uint8_t repeat);
  void transferBytes_(uint8_t * out, uint8_t * in, uint8_t size);
  void transferDwords_(uint32_t * out, uint32_t * in, uint8_t size);
public:
